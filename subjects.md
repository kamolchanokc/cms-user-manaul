...
### แถบรายวิชารออนุมัติ (ติดตามคำขอของตัวเอง)
...
```mermaid
flowchart LR
    A["บันทึกข้อมูลรายวิชา<br/>(เพิ่ม / แก้ไข / ปรับปรุง / ปิด-เปิดใช้งาน)"] --> B["รอตรวจสอบ / อนุมัติ"]
    B -->|"อนุมัติ"| C["หลักสูตรนำไปใช้งาน<br/>(เปิดใช้งาน / ปิดใช้งาน)"]
    B -->|"ปฏิเสธ (ระบุเหตุผล)"| A
    B -->|"ยกเลิกคำขอโดยคณะ"| Z["สถานะเดิม"]
```
...
> ℹ️ **รหัสวิชาต้องไม่ซ้ำ** ระบบตรวจสอบให้อัตโนมัติขณะพิมพ์ และแจ้งเตือนทันทีถ้ารหัสนั้นถูกใช้แล้ว ไม่ว่าจะเป็นรายวิชาของหลักสูตรใดหรือรายวิชา GenEd ใดก็ตาม (ดูความหมายรหัสประเภทวิชาแต่ละตัวได้ที่ตาราง [รหัสประเภทวิชา](subjects.md#รหัสประเภทวิชา) ด้านบน)
