...
4. ระบบแสดงผลลัพธ์เป็นตารางทันที (ไม่ต้องกดปุ่มค้นหา ผลจะกรองทันทีที่เปลี่ยนตัวกรอง)

**ตัวกรองข้อมูลหลักสูตร**

![ตัวกรองข้อมูลหลักสูตรด้านบนตาราง](.gitbook/assets/img-005.png)
...
![คลิกหัวคอลัมน์เพื่อเรียงลำดับผลลัพธ์](.gitbook/assets/img-006.png)

1. เลื่อนหน้า (pagination) ด้านล่างตารางเมื่อผลลัพธ์มีหลายรายการ

![การเลื่อนหน้า (pagination) ด้านล่างตาราง](.gitbook/assets/img-007.png)

1. คลิกที่ไอคอนของรายการหลักสูตรเพื่อ เปิดดูรายละเอียดหลักสูตร

![ไอคอนเปิดดูรายละเอียดหลักสูตร](.gitbook/assets/img-008.png)

## ข้อมูลที่ดูได้ในรายละเอียดหลักสูตร

เมื่อเปิดดูหลักสูตรรายการใดรายการหนึ่ง จะพบแท็บข้อมูลดังนี้

![แท็บข้อมูลในหน้ารายละเอียดหลักสูตร](.gitbook/assets/img-009.png)
