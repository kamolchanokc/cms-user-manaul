...
| ปรับปรุงหลักสูตร  | ปรับปรุงหลักสูตรที่มีอยู่แล้วให้เป็นปัจจุบัน พร้อมส่งอนุมัติ              |
...
flowchart TD
    ...
    Q -->|สร้างใหม่| A["เพิ่มหลักสูตร"]
    Q -->|"เปลี่ยนโครงสร้าง / หน่วยกิต / PLO"| B["ปรับปรุงหลักสูตร"]
    Q -->|แก้ปลีกย่อย| C["ปรับปรุงเล็กน้อย"]
    Q -->|เลิกหลักสูตร| D["ปิดหลักสูตร"]
```
...
| ผู้ดูแลระบบ (Admin)                    | สร้างหลักสูตรใหม่ ปรับปรุงหลักสูตรใหม่ ตั้งค่าระบบ และดูแลข้อมูลกลาง รวมทั้งกรอกข้อมูลการอนุมัติหลักสูตรทุกขึ้นตอน |
