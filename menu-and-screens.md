...
เมนูทั้งหมดอยู่ที่แถบด้านซ้ายของหน้าจอ แบ่งออกเป็น 3 กลุ่มหลัก เมื่อคลิกเมนูกลุ่ม ระบบจะกางรายการเมนูย่อยให้เลือก

> หมายเหตุ: เมนูที่มองเห็นได้ขึ้นอยู่กับสิทธิ์การใช้งานที่ได้รับ บางเมนูอาจไม่ปรากฏสำหรับผู้ใช้บางกลุ่ม (เมนูสำหรับผู้ดูแลระบบ/หลังบ้าน เช่น การตั้งค่าข้อมูลพื้นฐาน ไม่ได้กล่าวถึงในคู่มือฉบับนี้)
...
![โครงสร้างหน้าจอหลัก: เมนูซ้าย แถบบน และพื้นที่ทำงาน](.gitbook/assets/img-001.png)
...
![เมนูจัดการหลักสูตรและปุ่มการดำเนินการ](.gitbook/assets/img-002.png)
