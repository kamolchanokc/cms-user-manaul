...
1. แถบด้านบน (Top bar): แสดงชื่อผู้ใช้ การแจ้งเตือน และปุ่มออกจากระบบ
1. พื้นที่ทำงานตรงกลาง: เนื้อหาของหน้าที่เลือก
ระบบรองรับการใช้งานบนมือถือและแท็บเล็ต (Responsive) ตาราง ฟอร์ม และหน้าอนุมัติจะปรับการจัดวางให้เหมาะกับขนาดจอโดยอัตโนมัติ
