...
<table><thead><tr><th width="60">ลำดับ</th><th width="160">ระดับ</th><th>คืออะไร</th><th width="180">มีทุกหลักสูตรไหม</th></tr></thead><tbody><tr><td>1</td><td>🎓 <strong>วิชาเอก</strong></td><td>สาขาย่อยของหลักสูตร (เช่น เอกไฟฟ้า, เอกเครื่องกล) — แต่ละเอกมีชุดแผนการศึกษาเป็นของตัวเอง</td><td>เฉพาะหลักสูตรที่แบ่งสาขา/เอก</td></tr><tr><td>2</td><td>📘 <strong>แผนการศึกษา</strong></td><td>แผนการเรียนแบบหนึ่ง ๆ ของหลักสูตร/วิชาเอก (เช่น แผนปกติ 4 ปี, แผนสหกิจศึกษา) — กำหนดหน่วยกิตรวมและระยะเวลาเรียนของตัวเอง</td><td>ทุกหลักสูตร ต้องมีอย่างน้อย 1 แผน</td></tr><tr><td>3</td><td>🗂️ <strong>หมวดวิชา</strong></td><td>หมวดใหญ่ภายในแผน (เช่น หมวดวิชาศึกษาทั่วไป, หมวดวิชาเฉพาะ) กำหนดหน่วยกิตของหมวด</td><td>ทุกแผน มีได้หลายหมวด</td></tr><tr><td>4</td><td>📁 <strong>กลุ่ม</strong></td><td>กลุ่มวิชาภายในหมวด (เช่น กลุ่มวิชาบังคับ, กลุ่มวิชาเลือก) กำหนดหน่วยกิตของกลุ่มเอง</td><td>ทุกหมวด อย่างน้อยมี "ไม่ระบุกลุ่ม" อัตโนมัติ</td></tr><tr><td>5</td><td>📄 <strong>กลุ่มย่อย</strong></td><td>แบ่งย่อยลงไปอีกชั้นภายในกลุ่ม (รวมถึง Minor และกลุ่มสาระ GE) ใช้เมื่อกลุ่มนั้นต้องแยกละเอียดกว่าหนึ่งชั้น</td><td>เฉพาะกลุ่มที่ต้องแยกย่อย ไม่บังคับทุกกลุ่ม</td></tr><tr><td>6 (เล็กสุด)</td><td>📚 <strong>รายวิชา</strong></td><td>ตัวรายวิชาจริง — จุดปลายทางที่ทุกระดับด้านบนไล่ลงมาถึง</td><td>ทุกกลุ่ม/กลุ่มย่อยต้องมีรายวิชาอยู่ข้างใน (ยกเว้นติ๊ก "ไม่ระบุรายวิชา")</td></tr></tbody></table>
...
{% hint style="warning" %}
**อย่าสับสนกับ "ตัวเลือกโครงสร้างของแผน (เอกเดี่ยว/เอก-โท)"** — วิชาเอกในตารางด้านบนคือการแบ่งสาขาของ**ทั้งหลักสูตร** (แต่ละเอกมีแผนของตัวเอง) ส่วน "เอกเดี่ยว/เอก-โท" ที่จะกล่าวถึงถัดไป เป็นการแยกโครงสร้าง**ภายในแผนเดียวกัน** อีกชั้นหนึ่ง (เช่น แผนปกติ 4 ปีแผนเดียว แต่นักศึกษาเลือกได้ว่าจะเรียนเอกเดี่ยวหรือเอก-โท) — เป็นคนละกลไกกัน ใช้ร่วมกันได้แต่ไม่บังคับต้องมีทั้งคู่
{% endhint %}
