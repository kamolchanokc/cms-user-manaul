...
> 🟢 **แท็บนี้จะเป็นสีเขียวเมื่อ:** มีแผนการศึกษา (กรอกหน่วยกิตรวม + ระยะเวลาการศึกษาทุกแผน) · เพิ่มหมวดวิชาในโครงสร้าง · หน่วยกิตในหมวด/กลุ่มครบตามหน่วยกิตรวม · **ทุกรายวิชาต้องมี CLO** — (แท็บ PLOs รายวิชา · กลยุทธ์การสอน · PLOs & K A S ไม่นับในเงื่อนไขแท็บเขียว แต่จำเป็นต่อความสมบูรณ์ของเล่ม)

| แท็บย่อย | ภาพรวมสิ่งที่ทำ | บังคับกรอก |
| --- | --- | :---: |
| **จัดการรายวิชา** | เพิ่ม/แก้ไขรายวิชาทั้งหมดของหลักสูตร พร้อม CLO และเงื่อนไขการลงทะเบียน | ทุกรายวิชาต้องมี CLO <mark style="color:red;" title="บังคับกรอกเพื่อให้แท็บเป็นสีเขียว">\*</mark> |
| **แผนการศึกษา** | สร้างแผน · โครงสร้างหมวด/กลุ่มวิชา · แผนการเรียนรายปี · แผนการรับนักศึกษา (ดูรายละเอียดด้านล่าง) | หน่วยกิตรวม/ระยะเวลา/หมวดวิชา/เครดิตครบ <mark style="color:red;" title="บังคับกรอกเพื่อให้แท็บเป็นสีเขียว">\*</mark> |
| **PLOs รายวิชา** (ไม่นับในเงื่อนไขแท็บเขียว) | ตาราง Mapping ความรับผิดชอบระหว่าง PLOs (แต่ละชุด) กับรายวิชาแต่ละวิชา | |
| **กลยุทธ์และวิธีการสอน** (ไม่นับในเงื่อนไขแท็บเขียว) | กลยุทธ์/วิธีการสอน และวิธีวัดและประเมินผล แยกตามผลลัพธ์การเรียนรู้ | |
| **PLOs & K A S** (ไม่นับในเงื่อนไขแท็บเขียว) | จัดการคลัง Knowledge/Attitude/Skill และแมพเข้ากับ PLO | |

#### แท็บย่อย: จัดการรายวิชา

เพิ่มรายวิชาทีละวิชา (หรือนำเข้าจาก Excel) แต่ละวิชากรอกข้อมูลใน 4 ส่วน

| ส่วน | ฟิลด์ | บังคับกรอก |
| --- | --- | :---: |
| **ข้อมูลรายวิชา** | หน่วยงานบริหารจัดการหลักสูตร (เลือกก่อนกำหนดรหัสวิชา) · รหัสวิชา · ประเภทวิชา · ชื่อรายวิชา (ไทย/อังกฤษ) · คำอธิบายรายวิชา (ไทย/อังกฤษ) · จำนวนหน่วยกิต · รูปแบบหน่วยกิต · ชั่วโมงบรรยาย/ปฏิบัติ/ศึกษาด้วยตนเอง · ประเภทห้องเรียน · ตัวเลือก Active Learning / WIL / Module | |
| **CLOs** (ผลลัพธ์การเรียนรู้รายวิชา) | รหัส CLOs · รายละเอียด (ไทย) · รายละเอียด (อังกฤษ) | ทุกรายวิชาต้องมี CLO อย่างน้อย 1 ข้อ <mark style="color:red;" title="บังคับกรอกเพื่อให้แท็บเป็นสีเขียว">\*</mark> |
| **เงื่อนไขการลงทะเบียน** | รายวิชาที่ต้องเรียนก่อน (รหัส/ชื่อวิชา/หน่วยกิต) | |
| **การอนุมัติ/เปิด-ปิดรายวิชา** | วันที่อนุมัติ · วันที่เปิดสอนครั้งแรก · ภาคเรียน/ปีการศึกษาที่เปิดสอน · (กรณีปิด) วันที่ปิดใช้งาน · ภาคเรียน/ปีที่ปิด · เหตุผลการปิด | |

> 💡 รองรับการนำเข้ารายวิชาและ CLOs จากไฟล์ Excel (มีปุ่มดาวน์โหลด Template แล้วอัปโหลดกลับ)

#### แท็บย่อย: แผนการศึกษา (แท็บที่ซับซ้อนที่สุด)

หนึ่งหลักสูตรมีได้หลายแผนการศึกษา และถ้าหลักสูตรแบ่งวิชาเอก จะมีแท็บแยกตามวิชาเอก แต่ละแผนประกอบด้วย 4 ส่วน + การตั้งค่าเสริม

**1) ข้อมูลแผน** — ปุ่มเพิ่ม/แก้ไขแผน
...
**2) โครงสร้าง** — ปุ่ม "เปิดรายละเอียดโครงสร้างหลักสูตรของแผนนี้" (โครงสร้างเป็นลำดับชั้น หมวดวิชา → กลุ่ม → กลุ่มย่อย → รายวิชา)

| ระดับ | ฟิลด์ที่กำหนด | บังคับกรอก |
| --- | --- | :---: |
| **หมวดวิชา** | ชื่อหมวดวิชา · จำนวนหน่วยกิต (ของหมวด) · ตั้งค่าหมวดวิชา · ตัวเลือก "ไม่ระบุรายวิชาในหมวดนี้ (นับเครดิตเต็มจำนวนอัตโนมัติ)" | ชื่อหมวดวิชา + จำนวนหน่วยกิต <mark style="color:red;" title="บังคับกรอกเพื่อให้แท็บเป็นสีเขียว">\*</mark> |
...
> ⚠️ **หน่วยกิตต้องครบ:** ผลรวมหน่วยกิตในหมวด/กลุ่ม/รายวิชา ต้องรวมได้ครบตาม "จำนวนหน่วยกิตรวม" ของแผน แท็บจึงจะเป็นสีเขียว (ระบบมีข้อความช่วยเตือนหน่วยกิตที่ยังขาด/เกิน)

**3) แผนการเรียน** — จัดรายวิชาลงแต่ละชั้นปีและภาคการศึกษา
...
| ปีการศึกษา · จำนวนรับต่อปี · จำนวนรวม | |

**การตั้งค่าเสริมของแผน**

| รายการ | รายละเอียด |
| --- | --- |
| ประเภทโครงสร้าง | เลือกรูปแบบโครงสร้าง เช่น เอกเดี่ยว / เอก-โท (แสดงเมื่อหลักสูตรมีการแบ่งวิชาเอก/โท) |
| เกณฑ์การสำเร็จการศึกษา | เพิ่ม/แก้ไขเกณฑ์เป็นข้อ ๆ (ลำดับข้อ · รายละเอียด) |
| คัดลอกข้อมูล | ปุ่ม "คัดลอกข้อมูลทั้งวิชาเอก" และ "คัดลอกข้อมูลแผน" เพื่อลอกโครงสร้าง/แผนจากวิชาเอกหรือแผนอื่นมาตั้งต้น |

#### แท็บย่อย: PLOs รายวิชา

ตาราง Mapping ความรับผิดชอบระหว่าง PLOs (แต่ละชุด) กับรายวิชาแต่ละวิชา — ค้นหาด้วยรหัส/ชื่อวิชา แล้วทำเครื่องหมายความรับผิดชอบในแต่ละช่อง (ไม่นับในเงื่อนไขแท็บเขียว)

#### แท็บย่อย: กลยุทธ์และวิธีการสอน

ระบุกลยุทธ์/วิธีการสอน และวิธีการวัดและประเมินผล แยกตามผลลัพธ์การเรียนรู้แต่ละข้อ (ไม่นับในเงื่อนไขแท็บเขียว)
