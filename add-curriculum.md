...
##### ลำดับชั้นทั้งหมด (จากใหญ่สุดไปเล็กสุด)

ก่อนลงรายละเอียดแต่ละส่วน ให้เห็นภาพรวมก่อนว่าข้อมูลในหมวด "แผนการศึกษา" ทั้งหมดเรียงเป็นชั้น ๆ ตั้งแต่หน่วยใหญ่สุดจนถึงหน่วยเล็กสุดดังนี้

<table><thead><tr><th width="60">ลำดับ</th><th width="160">ระดับ</th><th>คืออะไร</th><th width="180">มีทุกหลักสูตรไหม</th></tr></thead><tbody><tr><td>1</td><td>🎓 <strong>วิชาเอก</strong></td><td>สาขาย่อยของ<strong>ทั้งหลักสูตร</strong> (เช่น เอกไฟฟ้า, เอกเครื่องกล) — แต่ละเอกมีชุดแผนการศึกษาเป็นของตัวเอง</td><td>เฉพาะหลักสูตรที่แบ่งสาขา/เอก</td></tr><tr><td>2</td><td>📘 <strong>แผนการศึกษา</strong></td><td>แผนการเรียนแบบหนึ่ง ๆ ของหลักสูตร/วิชาเอก (เช่น แผนปกติ 4 ปี, แผนสหกิจศึกษา) — กำหนดหน่วยกิตรวมและระยะเวลาเรียนของตัวเอง</td><td>ทุกหลักสูตร ต้องมีอย่างน้อย 1 แผน</td></tr><tr><td>3</td><td>⚙️ <strong>ตัวเลือกโครงสร้างของแผน</strong></td><td>จุดแยกย่อย<strong>ภายในแผนเดียวกัน</strong> (เช่น เอกเดี่ยว/เอก-โท) — คนละเรื่องกับ "วิชาเอก" ที่แยกทั้งหลักสูตร (ดูคำเตือนด้านล่าง)</td><td>เฉพาะแผนที่ต้องแยกโครงสร้างย่อยอีกชั้น</td></tr><tr><td>4</td><td>🗂️ <strong>หมวดวิชา</strong></td><td>หมวดใหญ่ภายในแผน/ตัวเลือกโครงสร้าง (เช่น หมวดวิชาศึกษาทั่วไป, หมวดวิชาเฉพาะ) กำหนดหน่วยกิตของหมวด</td><td>ทุกแผน มีได้หลายหมวด</td></tr><tr><td>5</td><td>📁 <strong>กลุ่ม</strong></td><td>กลุ่มวิชาภายในหมวด (เช่น กลุ่มวิชาบังคับ, กลุ่มวิชาเลือก) กำหนดหน่วยกิตของกลุ่มเอง</td><td>ทุกหมวด อย่างน้อยมี "ไม่ระบุกลุ่ม" อัตโนมัติ</td></tr><tr><td>6</td><td>📄 <strong>กลุ่มย่อย</strong></td><td>แบ่งย่อยลงไปอีกชั้นภายในกลุ่ม (รวมถึง Minor และกลุ่มสาระ GE) ใช้เมื่อกลุ่มนั้นต้องแยกละเอียดกว่าหนึ่งชั้น</td><td>เฉพาะกลุ่มที่ต้องแยกย่อย ไม่บังคับทุกกลุ่ม</td></tr><tr><td>7 (เล็กสุด)</td><td>📚 <strong>รายวิชา</strong></td><td>ตัวรายวิชาจริง — จุดปลายทางที่ทุกระดับด้านบนไล่ลงมาถึง</td><td>ทุกกลุ่ม/กลุ่มย่อยต้องมีรายวิชาอยู่ข้างใน (ยกเว้นติ๊ก "ไม่ระบุรายวิชา")</td></tr></tbody></table>

```mermaid
flowchart TD
    A["🎓 วิชาเอก<br/>เช่น เอกไฟฟ้า"] --> B["📘 แผนการศึกษา<br/>เช่น แผนปกติ 4 ปี"]
    B -.->|"ถ้ามีตัวเลือกโครงสร้าง"| V["⚙️ ตัวเลือกโครงสร้างของแผน<br/>เช่น เอกเดี่ยว/เอก-โท"]
    B --> C1["🗂️ หมวดวิชาศึกษาทั่วไป"]
    B --> C2["🗂️ หมวดวิชาเฉพาะ"]
    V -.->|"ถ้าไม่มีตัวเลือก ข้ามตรงมาที่นี่"| C1
    C1 --> D1["📁 กลุ่มวิชาบังคับ GE"]
    C2 --> D2["📁 กลุ่มวิชาบังคับ"]
    C2 --> D3["📁 กลุ่มวิชาเลือก"]
    D1 --> E1["📄 กลุ่มสาระ GE / กลุ่มย่อย"]
    D2 --> E2["📚 รายวิชา"]
    D3 --> E3["📚 รายวิชา"]
    E1 --> F1["📚 รายวิชา"]
```
...
{% hint style="warning" %}
**อย่าสับสน "วิชาเอก" กับ "ตัวเลือกโครงสร้างของแผน (เอกเดี่ยว/เอก-โท)"** — ทั้งสองคำมีคำว่า "เอก" เหมือนกันแต่อยู่กันคนละชั้น: **วิชาเอก** (ลำดับ 1) คือการแบ่งสาขาของ**ทั้งหลักสูตร** ทำให้เกิด**หลายแผนการศึกษา**แยกตามเอก ส่วน **ตัวเลือกโครงสร้างของแผน** (ลำดับ 3) คือการแยกโครงสร้าง**ภายในแผนเดียวกัน**อีกชั้นหนึ่ง (เช่น แผนปกติ 4 ปีแผนเดียว แต่นักศึกษาเลือกได้ว่าจะเรียนเอกเดี่ยวหรือเอก-โท) — เป็นคนละกลไกกัน ใช้ร่วมกันได้ ใช้แยกกันได้ และไม่บังคับต้องมีทั้งคู่ ดูรายละเอียดจุดแตกแขนงนี้ต่อในหัวข้อถัดไป
{% endhint %}

##### โครงสร้างย่อยของ "แผนหลัก" — ตัวเลือกโครงสร้างของแผน (ลึกลงไปอีกชั้น)

ก่อนจะไล่ลงไปถึงหมวดวิชา/กลุ่ม แผนการศึกษา 1 แผนต้อง**ตัดสินใจก่อนว่าจะมีโครงสร้างเดียว หรือแยกเป็นเอกเดี่ยว/เอก-โท** — นี่คือจุดแตกแขนงแรกสุดที่อยู่**ใต้แผนหลัก**และ**เหนือ**หมวดวิชา

<table><thead><tr><th width="200">กรณี</th><th>รายละเอียด</th></tr></thead><tbody><tr><td>🚫 <strong>ไม่มีตัวเลือกโครงสร้าง</strong></td><td>แผนใช้ <strong>"ไม่ระบุเอกย่อย"</strong> — หมวดวิชา/กลุ่ม/รายวิชาผูกอยู่กับตัวแผนโดยตรงเพียงชุดเดียว (กรณีส่วนใหญ่)</td></tr><tr><td>⚙️ <strong>มีตัวเลือกโครงสร้าง</strong></td><td>แผนถูกแยกเป็นหลาย "ตัวเลือกโครงสร้าง" (เช่น เอกเดี่ยว, เอก-โท) แต่ละตัวเลือกมีชุดหมวดวิชา/กลุ่ม/รายวิชา<strong>เป็นอิสระจากกันโดยสมบูรณ์</strong> — แก้ของเอกเดี่ยวไม่กระทบเอก-โท และกลับกัน</td></tr></tbody></table>

```mermaid
flowchart TD
    P["📘 แผนการศึกษา<br/>เช่น แผนปกติ 4 ปี"] --> Q{"มีตัวเลือกโครงสร้างของแผนไหม?"}
    Q -->|"ไม่มี → ไม่ระบุเอกย่อย"| S["🗂️ หมวดวิชา → 📁 กลุ่ม → 📄 กลุ่มย่อย → 📚 รายวิชา<br/>(ชุดเดียว ผูกกับแผนตรง ๆ)"]
    Q -->|"มี → เพิ่มตัวเลือกโครงสร้าง"| V1["⚙️ ตัวเลือก: เอกเดี่ยว"]
    Q -->|"มี → เพิ่มตัวเลือกโครงสร้าง"| V2["⚙️ ตัวเลือก: เอก-โท"]
    V1 --> S1["🗂️ หมวดวิชา → 📁 กลุ่ม → 📄 กลุ่มย่อย → 📚 รายวิชา<br/>(ชุดของเอกเดี่ยวเอง)"]
    V2 --> S2["🗂️ หมวดวิชา → 📁 กลุ่ม → 📄 กลุ่มย่อย → 📚 รายวิชา<br/>(ชุดของเอก-โทเอง)"]
```

{% hint style="warning" %}
สลับไปมาระหว่าง **"ไม่ระบุเอกย่อย"** กับ **"มีตัวเลือกโครงสร้าง"** ได้เฉพาะตอนที่ยังไม่มีข้อมูลโครงสร้างผูกอยู่เท่านั้น และตัวเลือกโครงสร้างแต่ละอันจะ**ลบไม่ได้ถ้ามีหมวด/กลุ่ม/รายวิชาอยู่แล้วข้างใน** ต้องลบข้อมูลโครงสร้างภายในให้หมดก่อนจึงจะลบตัวเลือกนั้นได้ (รายละเอียดเพิ่มเติมดูหัวข้อ "ตัวเลือกโครงสร้างของแผน" ด้านล่าง)
{% endhint %}
...
K A S = **K**nowledge (ความรู้) / **A**ttitude (ทัศนคติ) / **S**kill (ทักษะ) — มี 2 โหมดย่อย สลับด้วยปุ่ม toggle ด้านบน: **"จัดการคลัง K/A/S"** และ **"PLOs K/A/S"**

{% hint style="warning" %}
K/A/S บังคับกรอกเฉพาะ**หลักสูตรที่ใช้ปีหน้าปกตั้งแต่ พ.ศ. 2564 ขึ้นไป** หลักสูตรที่ใช้ปีหน้าปกก่อน 2564 ไม่จำเป็นต้องกรอกส่วนนี้
{% endhint %}

**โหมด "จัดการคลัง K/A/S"**

แบ่งเป็น 3 แท็บย่อยตามประเภท **K / A / S** แต่ละแท็บมีช่องค้นหา (รหัส/รายละเอียด) และปุ่ม **"เพิ่ม K" / "เพิ่ม A" / "เพิ่ม S"** เพื่อเพิ่มรายการใหม่เข้าคลัง

<table><thead><tr><th width="220">เครื่องมือ</th><th>รายละเอียด</th></tr></thead><tbody><tr><td><strong>เลือกรายการ</strong></td><td>เข้าโหมดติ๊กเลือกหลายรายการ พร้อมปุ่ม "เลือกทั้งหมด" และ <strong>"ลบรายการที่เลือก"</strong> เพื่อลบพร้อมกัน</td></tr><tr><td><strong>นำเข้า K/A/S ด้วย Excel</strong></td><td>เพิ่มรายการจำนวนมากพร้อมกันจากไฟล์ Excel</td></tr><tr><td><strong>ลากเรียงลำดับ</strong></td><td>ลากรายการในคลังเพื่อจัดลำดับการแสดงผลใหม่ได้โดยตรง</td></tr></tbody></table>

**โหมด "PLOs K/A/S"**

ตาราง Mapping ระหว่าง **PLO** (แถว จัดกลุ่มแบบเดียวกับแท็บกลยุทธ์และวิธีการสอน — ผูกทุกแผนไว้บนสุด แล้วตามด้วยกลุ่มเฉพาะแต่ละแผน) กับ **ประเภท K / A / S** (คอลัมน์) แต่ละช่องแสดงรายการ K/A/S ที่จับคู่ไว้แล้วเป็นชิป พร้อมปุ่ม **"เลือก"** ท้ายช่องเพื่อเปิดหน้าต่างเลือกจากคลัง (เลือกได้หลายรายการต่อช่อง)

* กดเครื่องหมาย **✕ บนชิป** เพื่อนำรายการนั้นออกจาก PLO ข้อนั้น (มีกล่องยืนยันก่อนทุกครั้ง)
* การเพิ่ม/นำออกแต่ละครั้ง**บันทึกลงระบบทันที** ไม่ต้องกดปุ่มบันทึกรวมท้ายหน้าเหมือนตารางอื่น

{% hint style="info" %}
ต้องมีรายการอยู่ในคลัง (โหมด "จัดการคลัง K/A/S") ก่อน จึงจะกด **"เลือก"** เพื่อจับคู่กับ PLO ได้ — ถ้าคลังของประเภทนั้นยังว่าง ปุ่ม "เลือก" ของคอลัมน์นั้นจะถูกปิดใช้งาน
{% endhint %}
