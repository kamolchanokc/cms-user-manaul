...
{% hint style="warning" %}
**ชื่อหมวดซ้ำกันภายในแผนเดียวกันไม่ได้** และถ้าชื่อหมวดมีคำว่า **"ศึกษาทั่วไป"** ระบบจะรู้จำเป็น**หมวด GE โดยอัตโนมัติ** — ปุ่ม/ตัวเลือกเพิ่มรายวิชาในหมวดนั้นทั้งหมดจะเปลี่ยนเป็นชุดของ GE (เพิ่มกลุ่มสาระ GE / เพิ่มกลุ่มย่อย) แทนปุ่มเพิ่มรายวิชาทั่วไปโดยอัตโนมัติ
{% endhint %}
...
> ℹ️ ปุ่มเพิ่มข้างต้นจะถูกปิดใช้งานพร้อมคำอธิบายใต้ปุ่ม เมื่อยังกรอกหน่วยกิตกลุ่มไม่ครบ หรือยังไม่ได้บันทึกกลุ่ม
